...
public class RequestPermissionHandler : IRequestHandler<RequestPermissionCommand, Response<int>>
{
    ...
    public RequestPermissionHandler(IUnitOfWork unitOfWork, IMapper mapper, IKafkaProducerService kafka, IElasticsearchService elasticsearch)
    {
    ...
    {
        var permiso = new PermissionEntity
        {
        ...
        await _unitOfWork.PermissionRepository.AddAsync(permiso);
        ...
        return new Response<int>(permiso.Id, "Permiso creado exitosamente");
    }
}
